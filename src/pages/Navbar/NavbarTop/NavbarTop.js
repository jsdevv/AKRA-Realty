...
import {  FaHeart, FaTimes,FaChevronUp, FaChevronDown, FaHome, FaRegBell, FaPlus } from 'react-icons/fa'; // Import the close icon
  ...
  return (
    <div className="navbar-top">
      ...
      <div className="navbar-center">
        ...
        <Link 
                to="/feedback" 
                className={`navbar-centerlink ${activeLink === 'feedback' ? 'active' : ''}`} 
                onClick={() => handleLinkClick('feedback')}
              >
                 <VscFeedback size={22} className="home-icon" />
              </Link>
          <Link 
               to="/addlistings" 
